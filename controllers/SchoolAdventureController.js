...
const productuploadDetails = require("../models/SchoolAdventureModel");
...
const FetchGalleryData = asynchandler(async (req, res) => {
  try {
    ...
    res.status(200).json({ ProductDataAdventure: productData });
...
const DeleteAdventureData = asynchandler(async (req, res) => {
...
module.exports = { GalleryDataUpload, FetchGalleryData,DeleteAdventureData };
